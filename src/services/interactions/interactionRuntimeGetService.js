...
class InteractionRuntimeGetService extends Service {
  constructor() {
    super(DEFAULT_TOPICS.SERVICES.INTERACTION_RUNTIME_GET);
  }
  ...
  reply(interactionMessage) {
    ...
    if (typeof interaction === 'undefined') {
      return {
        error: {
          title: 'InteractionRuntimeGetService Error',
...
module.exports = {
  'InteractionRuntimeGetService': InteractionRuntimeGetService
};